...
//            tbc.tabBar.backgroundImage = image
            if let tbItems = tbc.tabBar.items {
                ...
                tbItems[1].image = UIImage(named: "rss.png")?.withRenderingMode(.alwaysOriginal)
...
//                tbItems[2].image = UIImage(named: "photo.png")
                ...
                tbItems.forEach { (item) in
                    item.selectedImage = UIImage(named: "checkmark")?.withRenderingMode(.alwaysOriginal)
                }
